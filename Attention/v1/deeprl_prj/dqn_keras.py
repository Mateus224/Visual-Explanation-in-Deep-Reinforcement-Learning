    ...
    with tf.variable_scope(model_name):
        ...
        if mode == "duel_at_improved":
            ...
            if args.bidir:
                ...
                value_hidden_out = Bidirectional(LSTM(512, return_sequences=True,  name = 'action_hidden_out', stateful=False, input_shape=(args.num_frames, 512)), merge_mode='sum') (value_hidden)
                ...
                action_hidden_out = Bidirectional(LSTM(512, return_sequences=True,  name = 'action_hidden_out', stateful=False, input_shape=(args.num_frames, 512)), merge_mode='sum') (action_hidden)
...
class DQNAgent:
    ...
    def __init__(self, args, num_actions):
        ...
        if self.load_network:
            ...
            self.target_network.load_weights(self.load_network_path)
    ...
    def evaluate(self, env, num_episodes, eval_count, max_episode_length=None, monitor=True):
        ...
        if self.load_network:
            ...
            if self.convert:
                ...
                plot_model(self.q_network, to_file='model_plot.png', show_shapes=True, show_layer_names=True)
                return 
        if monitor:
