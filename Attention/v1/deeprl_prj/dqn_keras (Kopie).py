        ...
        if mode == "linear":
            ...
            if not(args.recurrent):
                ...
                if not(args.a_t):
                    ...
                    sent_representation = merge([output, attention], mode='mul')
                    context = Lambda(lambda xin: K.sum(xin, axis=-2), output_shape=(18,))(sent_representation)
                    # print(context.shape)

            #if mode == "dqn":
            #h4 = Dense(18, activation='relu', name = "fc")(context)
