def add_arguments(parser):
    ...
    parser.add_argument('--initial_epsilon', type=float, default = 0.01, help='Initial value of epsilon in epsilon-greedy')
    parser.add_argument('--final_epsilon', type=float, default = 0.001, help='Final value of epsilon in epsilon-greedy')
    ...
    parser.add_argument('--test_dqn_model_path', type=str, default = "saved_dqn_networks/breakout_dqn_10000000.h5", help='')
