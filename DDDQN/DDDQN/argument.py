def add_arguments(parser):
    ...
    parser.add_argument('--save_interval', type=int, default = 30000, help='The frequency with which the network is saved')
    ...
    parser.add_argument('--test_dqn_model_path', type=str, default = "saved_dqn_networks/breakout_dqn_210000.h5", help='')
